...
('00000000-0000-0000-0000-000000000003', 'Andres', 'Salazar', 'andres.salazar@colegiosol.edu.co', 'User12345*', '100000003', '{"teacher":{"specialty":"Matematicas","contract_type":"Tiempo completo"}}'),
('00000000-0000-0000-0000-000000000004', 'Paula', 'Mejia', 'paula.mejia@colegiosol.edu.co', 'User12345*', '100000004', '{"teacher":{"specialty":"Lengua castellana","contract_type":"Medio tiempo"}}'),
...
('00000000-0000-0000-0000-000000000007', 'Sofia', 'Torres', 'sofia.torres@colegiosol.edu.co', 'User12345*', '100000007', '{"student":{"birth_date":"2016-04-12","medical_notes":"Sin restricciones"}}'),
('00000000-0000-0000-0000-000000000008', 'Mateo', 'Torres', 'mateo.torres@colegiosol.edu.co', 'User12345*', '100000008', '{"student":{"birth_date":"2014-09-23","medical_notes":"Alergia leve al polvo"}}'),
('00000000-0000-0000-0000-000000000009', 'Valentina', 'Moreno', 'valentina.moreno@colegiosol.edu.co', 'User12345*', '100000009', '{"student":{"birth_date":"2015-02-02","medical_notes":"Sin restricciones"}}'),
('00000000-0000-0000-0000-000000000010', 'Samuel', 'Caceres', 'samuel.caceres@colegiosol.edu.co', 'User12345*', '100000010', '{"student":{"birth_date":"2017-11-17","medical_notes":"Usa lentes"}}');
...
INSERT INTO courses (id, name, grade, academic_year, monthly_fee_amount) VALUES
(1, 'Primero A', '1', 2026, 420000.00),
(2, 'Tercero A', '3', 2026, 450000.00),
(3, 'Cuarto B', '4', 2026, 470000.00);
